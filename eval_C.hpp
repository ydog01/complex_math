...
namespace eval
{
    ...
    struct eval
    {
        ...
        constin(constin_),
        stot(stot_),    
        vars(vars_ ? vars_ : std::make_shared<sstree<var<type>>>()),  // 使用make_shared
        funcs(funcs_ ? funcs_ : std::make_shared<sstree<func<type>>>()),
        oper1(oper1_ ? oper1_ : std::make_shared<sstree<func<type>>>()),
        oper2(oper2_ ? oper2_ : std::make_shared<sstree<func<type>>>()) {}
